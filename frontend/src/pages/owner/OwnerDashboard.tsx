...
export const OwnerDashboard = () => {
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title="Ringkasan Koleksi"
        description="Kelola identitas hewan peliharaan, riwayat vaksinasi, koreksi data, dan transfer kepemilikan."
      />
      <section className="grid gap-3 md:grid-cols-4">
        {[
          { title: 'Terbitkan Identitas', desc: 'Mendaftarkan hewan baru ke sistem dan blockchain.' },
          { title: 'Ajukan Koreksi Data', desc: 'Mengusulkan penyesuaian data identitas hewan.' },
          { title: 'Transfer Kepemilikan', desc: 'Memindahkan kepemilikan ke pemilik hewan yang lain.' },
          { title: 'Pantau Status', desc: 'Melihat histori vaksin dan riwayat aktivitas.' },
        ].map((item) => (
          <div
            key={item.title}
