...
export const OwnerAccountPage = () => {
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <PageHeader
        title="Profil Pemilik Hewan"
        description="Kelola identitas akun dan keamanan akses dasbor Anda."
      />
      <section className="rounded-3xl border border-white/60 bg-white/90 p-6 shadow-lg shadow-primary/5">
        ...
        <p className="mt-1 text-sm text-slate-500">
          Perbarui nama dan surel. Masuk akun ini menggunakan dompet digital blockchain (tanpa kata sandi).
        </p>
        {loadingProfile ? (
          ...
          <form className="mt-4 space-y-4" onSubmit={handleSubmit}>
            ...
            {walletAddress && (
              <div className="rounded-2xl bg-mist/70 px-4 py-3 text-xs text-slate-500">
                <p className="font-semibold text-secondary">Dompet digital terhubung</p>
