...
export const AdminPetsPage = () => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Direktori Global"
        description="Pantau seluruh data hewan yang berhasil diterbitkan oleh pemilik hewan."
      />
      ...
      <section className="rounded-3xl border border-white/60 bg-white/90 p-6 shadow-lg shadow-primary/5">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500">Cari berdasarkan nama, public ID, atau pemilik hewan.</p>
          </div>
          <div className="flex flex-wrap gap-3">
            <div className="min-w-[240px]">
              <TextField
                ...
                placeholder="Nama, public ID, atau pemilik hewan"
              />
            </div>
            <button
              type="button"
            ...
            <table className="min-w-full text-left text-sm">
              <thead className="text-xs uppercase text-slate-400">
                <tr>
                  ...
                  <th className="px-3 py-2">Pemilik Hewan</th>
                </tr>
              </thead>
              <tbody>
                {pets.map((pet) => (
