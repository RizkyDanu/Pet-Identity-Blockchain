...
const roleOptions: Array<{ value: UserRole; label: string }> = [
  { value: 'OWNER', label: 'Pemilik Hewan' },
  { value: 'CLINIC', label: 'Klinik Hewan' },
  // { value: 'ADMIN', label: 'Admin' },
  // { value: 'PUBLIC_VERIFIER', label: 'Verifikator Publik' },
];
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Admin mengelola peran dan metadata akun. Kata sandi dinonaktifkan karena autentikasi berbasis dompet digital."
      />
      ...
      <section className="rounded-3xl border border-white/60 bg-white/90 p-6 shadow-lg shadow-primary/5">
        ...
        <form className="mt-4 space-y-4" onSubmit={handleSubmit}>
          ...
          <TextField
            label={isEditing ? 'Dompet Digital' : 'Dompet Digital'}
          ...
          <p className="rounded-2xl bg-mist/70 px-4 py-3 text-xs text-slate-500">
            Catatan: akun berbasis dompet digital tidak mendukung ubah kata sandi dan dompet digital tidak dapat diubah/dihapus oleh admin.
          </p>
      ...
      <section className="rounded-3xl border border-white/60 bg-white/90 p-6 shadow-lg shadow-primary/5">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500">Filter peran, cari nama/surel, dan kelola akun.</p>
          </div>
          <div className="flex flex-wrap gap-3">
            <label className="block text-sm font-semibold text-secondary/80">
              Filter Peran
            ...
            <table className="min-w-full text-left text-sm">
              <thead className="text-xs uppercase text-slate-400">
                <tr>
                  ...
                  <th className="px-3 py-2">Surel</th>
                  <th className="px-3 py-2">Peran</th>
                  <th className="px-3 py-2">Dompet Digital</th>
