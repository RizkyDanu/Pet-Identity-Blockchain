    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500">
          Lengkapi data akun untuk mengakses layanan penerbitan identitas hewan, transfer kepemilikan dan riwayat vaksin.
        </p>
        <p className="mt-2 rounded-xl bg-mist/70 px-3 py-2 text-xs text-slate-600">
          Halaman ini khusus pendaftaran akun pemilik hewan. pendaftaran akun klinik dikelola terpisah oleh administrator.
        </p>
      </div>
