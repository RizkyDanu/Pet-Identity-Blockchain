    ...
    <div className="space-y-4">
      ...
      <section className="grid gap-3 md:grid-cols-4">
        {[
          ...
          { title: 'Tambah Catatan', desc: 'Mencatat vaksinasi/rekam medis baru.' },
          { title: 'Verifikasi Vaksinasi', desc: 'Menyetujui atau menolak catatan vaksinasi/rekam medis.' },
          { title: 'Koreksi Data', desc: 'Mengoreksi data yang diajukan pemilik hewan.' },
        ].map((item) => (
          <div
            key={item.title}
