...
export const ClinicPendingRecords = () => {
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title="Verifikasi Catatan Vaksinasi"
        description="Daftar vaksin/rekam medis dari klinik Anda yang siap diverifikasi."
      />
      ...
      <div className="space-y-3">
        ...
        {!loading && records.length === 0 && (
          <p className="text-sm text-slate-500">Tidak ada yang perlu diverifikasi saat ini.</p>
        )}
      </div>
    </div>
  );
